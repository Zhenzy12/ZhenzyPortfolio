			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<AnimatedSection>
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-400 max-w-3xl mx-auto">Learn more about my journey, education, and passion for technology</p>
					</div>
				</AnimatedSection>
				...
				<div className="grid lg:grid-cols-2 gap-16 items-start">
					...
					<div className="space-y-8">
						<AnimatedSection delay={200}>
							<div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
								<h2 className="text-2xl font-bold mb-6 text-emerald-400">Personal Information</h2>
								<div className="space-y-4">
									<div className="flex items-center space-x-4">
										<User className="h-5 w-5 text-emerald-400" />
										<span className="text-gray-300">Rie Zhenzy R. Zumel</span>
									</div>
									<div className="flex items-center space-x-4">
										<MapPin className="h-5 w-5 text-emerald-400" />
										<span className="text-gray-300">Baguio City, Philippines</span>
									</div>
									<div className="flex items-center space-x-4">
										<Mail className="h-5 w-5 text-emerald-400" />
										<span className="text-gray-300">zumelriezhenzy@gmail.com</span>
									</div>
									<div className="flex items-center space-x-4">
										<Phone className="h-5 w-5 text-emerald-400" />
										<span className="text-gray-300">+63 939 600 1945</span>
									</div>
									<div className="flex items-center space-x-4">
						...
						<AnimatedSection delay={400}>
							<div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
								<h2 className="text-2xl font-bold mb-6 text-emerald-400">Education</h2>
								<div className="space-y-6">
									<div className="flex items-start space-x-4">
										...
										<div>
											...
											<p className="text-gray-400">University of Baguio</p>
											<p className="text-sm text-gray-500">2020 - 2025</p>
											<p className="text-gray-300 mt-2">Graduated with comprehensive knowledge in software development, algorithms, data structures, and modern programming practices.</p>
										</div>
									</div>
								</div>
							</div>
						...
						<AnimatedSection delay={500}>
							<div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
								<h2 className="text-2xl font-bold mb-6 text-emerald-400">What I Bring</h2>
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
										<span className="text-gray-300">Full-Stack Development Skills</span>
									</div>
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
									...
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
										<span className="text-gray-300">Cloud & Deployment Knowledge</span>
									</div>
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
										<span className="text-gray-300">Attention to Detail</span>
									</div>
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
										<span className="text-gray-300">Analytical Thinking</span>
									</div>
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
										<span className="text-gray-300">User-Centric Design Approach</span>
									</div>
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
										<span className="text-gray-300">Team Collaboration & Communication</span>
									</div>
									<div className="flex items-center space-x-3">
										<div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
					...
					<div className="space-y-8">
						<AnimatedSection delay={300}>
							<div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
								<h2 className="text-2xl font-bold mb-6 text-emerald-400">My Story</h2>
								<div className="space-y-4 text-gray-300 leading-relaxed">
									<p>
										My journey into the tech world kicked off when I decided to study
										<span className="text-emerald-400"> Computer Science at the University of Baguio</span>
									...
									<p>
										...
										<span className="text-emerald-400"> Baguio City Smart City Command and Control Center Inventory System</span>
										. This project provided me with hands-on experience in developing a full-stack application using
										<span className="text-emerald-400"> Vue.js, Laravel, SQL and Tailwind CSS</span>
									...
									<p>
										...
										<span className="text-emerald-400"> AgriTayo</span>, an eCommerce platform designed to connect local farmers directly with buyers. This project not only enhanced my skills in
										<span className="text-emerald-400"> React.js, React Native, and Express.js </span>
									...
									<p>
										...
										<span className="text-emerald-400"> predicts student employability </span>
										based on various factors using
										<span className="text-emerald-400"> Python and scikit-learn</span>. This research provided me with a deeper understanding of machine learning principles and their applications in the real world.
									</p>
									<p>
